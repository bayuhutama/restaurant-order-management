  ...
  <div class="min-h-screen flex">
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center px-5 py-10 sm:px-8 sm:py-12 bg-white dark:bg-gray-900">
      <div class="w-full max-w-sm">
        ...
        <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-1">Staff Portal</h1>
        <p class="text-gray-500 dark:text-gray-400 text-sm mb-8">Sign in to access the order dashboard.</p>
